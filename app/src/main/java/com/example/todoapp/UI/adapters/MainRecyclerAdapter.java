...
import com.example.todoapp.Dtos.Section;
...
public class MainRecyclerAdapter extends RecyclerView.Adapter<MainViewHolder> {
    ...
    public MainRecyclerAdapter(List<Presupuesto> sectionItems, ChildRecyclerAdapter.OnItemChildClickListener itemClickListener) {
