...
import com.example.todoapp.Repositories.BudgetRepository;
import com.example.todoapp.Repositories.DailyExpensesRepository;
...
public class DailyExpensesVM extends ViewModel {
    ...
    public void addDailyExpense(GastoDia mainObject, OnSuccessListener<DocumentReference> onSuccess, OnFailureListener onFailure) {
